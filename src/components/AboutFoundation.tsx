    ...
    <section className="section-spacing py-12 sm:py-16 md:py-24 bg-background">
      <div className="section-container">
        <div className="max-w-4xl mx-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-serif font-semibold text-primary mb-1.5 sm:mb-2.5">
                      {pillar.title}
                    </h3>
          ...
          {/* Additional Info */}
          <div className="mt-8 sm:mt-12 p-5 sm:p-8 rounded-2xl bg-gradient-to-br from-primary/5 to-gold/5 border border-border/50">
